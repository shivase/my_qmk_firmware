...
[_LOWER] = LAYOUT( \
  ...
  BLE_EN,  BLE_DIS,  KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_PIPE,   KC_BSLS,   KC_BSPC,   KC_F10,  KC_F11,  KC_F12, \
  USB_EN,  USB_DIS,  KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_LEFT,  KC_DOWN, KC_UP, KC_RGHT, KC_RPRN, KC_TILD, \
